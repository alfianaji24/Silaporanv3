...
<head>
    ...
    <style>
        ...
        .datatable3 {
            ...
            /* Changed to separate for better sticky behavior */
            border-spacing: 0;
            font-size: 10px;
            min-width: 100%;
        }
        ...
        .datatable3 th {
            ...
            z-index: 20;
            height: 40px;
            /* Force height for predictable sticky offsets */
            line-height: 1.2;
        }
        ...
        @media screen {
            ...
            .datatable3 th.sticky-col {
                ...
                /* Bumped to ensure it's above all other headers */
                background-color: #024a75;
                border-left: 1px solid #333 !important;
                border-right: 1px solid #333 !important;
            }
            ...
            .datatable3 th.fourth-col,
            .datatable3 td.fourth-col {
                white-space: normal;
        ...
        <table class="datatable3">
            <thead>
                ...
                <tr>
                    ...
                    <th rowspan="3" class="sticky-col third-col">Nama</th>
                ...
                <tr>
                    ...
                    @while (strtotime($tanggal_presensi) <= strtotime($periode_sampai))
                        ...
                        if ($denda_db !== null) { $denda = $denda_db; }
                            ...
                            "<span style='color:" . (!empty($d[$tanggal_presensi][' jam_in']) ? "green" : "red" ) . "'>" . $jam_in . "</span> - " . "<span style='color:" . (!empty($d[$tanggal_presensi]['jam_out']) ? "green" : "red" ) . "'>" . $jam_out . "</span>" ;
