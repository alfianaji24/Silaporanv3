...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-masuk { width: 100%; padding: 0.875rem 1.5rem; background: var(--primary); color: #fff; border: none; border-radius: 0.5rem; font-size: 1rem; font-weight: 600; cursor: pointer; transition: background 0.2s; display: flex; align-items: center; justify-content: center; gap: 8px; }
        .btn-masuk:hover { background: var(--primary-hover); }
        .btn-masuk:disabled { opacity: 0.8; cursor: not-allowed; }
...
<body>
    <div class="login-container">
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <button type="submit" class="btn-masuk" id="btn-masuk-submit">Masuk</button>
        </form>
