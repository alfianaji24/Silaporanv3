...
<body>
        ...
        <div class="container">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="id_user" class="form-control" placeholder="Email / Username" autocomplete="off" required value="{{ old('id_user') }}">
                </div>
                ...
                <div class="forgot-pass">
                    <a href="#" id="lupakatasandi">Forgot Password</a>
                </div>

                <button type="submit" class="btn-login" id="btn-masuk-submit">Login</button>
            </form>
            ...
            <div class="social-login">
                ...
                <a href="#" class="social-btn" id="google-login" style="border: 1px solid #eee;">
                ...
                <a href="#" class="social-btn" id="apple-login">
                    <ion-icon name="logo-apple" class="apple-icon"></ion-icon>
                </a>
            </div>

            <div class="signup-text">
                Don't have account? <a href="#" id="linkDaftar">Sign Up</a>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.querySelector('form')?.addEventListener('submit', function(e) {
            const btn = document.getElementById('btn-masuk-submit');
            btn.disabled = true;
            btn.innerHTML = '<div class="spinner"></div>Tunggu...';
        });
