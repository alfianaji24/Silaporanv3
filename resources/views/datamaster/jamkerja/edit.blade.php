<form action="{{ route('jamkerja.update', Crypt::encrypt($jamkerja->kode_jam_kerja)) }}" id="formeditJamKerja" method="POST">
    ...
    <div class="form-group mb-3">
            ...
            @foreach ($jabatan as $j)
                <div class="form-check mb-2">
                    <input class="form-check-input" type="checkbox" name="kode_jabatan_terbatas[]"
                        ...
                        @checked(in_array($j->kode_jabatan, $kode_jabatan_terpilih ?? [], true))>
        ...
        <small class="text-muted d-block mt-1">Tanpa centang, jam kerja ini tidak ditampilkan ke siapa pun. Centang semua jabatan agar setara &quot;semua jabatan&quot;.</small>
    </div>
    <div class="form-group mb-3">
