        ...
        <div class="glass-effect rounded-2xl p-8 shadow-xl" data-aos="fade-up" data-aos-duration="1000">
            <div class="text-center">
                ...
                <div class="mb-6 floating" data-aos="zoom-in" data-aos-delay="200">
                    <img src="https://cdni.iconscout.com/illustration/premium/thumb/login-authentication-illustration-download-in-svg-png-gif-file-formats--secure-account-password-lock-screen-verification-pack-network-illustrations-6384733.png"
                        alt="Authentication Required" class="w-48 h-48 mx-auto">
                </div>
                ...
                <p class="text-gray-600 mb-8" data-aos="fade-up" data-aos-delay="600">
                    Maaf, Anda perlu login terlebih dahulu untuk mengakses halaman ini.
                </p>
