...
<div class="d-flex justify-content-between align-items-center w-100">
    <div>
        ...
        <div class="text-muted mt-1" style="font-size: 0.75rem; font-weight: normal; text-transform: none; letter-spacing: 0px;">
            Monitoring data presensi karyawan, rekap kehadiran, dan analisis kehadiran per periode.
        </div>
    </div>
        ...
        <ol class="breadcrumb breadcrumb-style1 mb-0">
            ...
            <li class="breadcrumb-item">
                <a href="javascript:void(0);">
                    <i class="ti ti-chart-bar ti-xs me-1"></i> Monitoring
                </a>
            </li>
            <li class="breadcrumb-item active">
                <i class="ti ti-calendar-check ti-xs me-1"></i> Presensi
            </li>
        </ol>
    </nav>
</div>
                                    ...
                                    <div class="card-body p-3">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                ...
                                                <span class="badge bg-label-secondary rounded-pill"><i class="ti ti-briefcase me-1"></i>{{ $d->nama_jabatan ?? '-' }}</span>
